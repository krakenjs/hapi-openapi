...
const create = function (options = {}) {
    ...
    const makeValidator = function (parameter, consumes, allowUnknownProperties = false) {
        ...
        if ((parameter.in === 'body' || parameter.in === 'formData') && parameter.schema) {
            ...
            schema = enjoi.schema(parameter.schema || parameter);
        }
...
const coercion = function (parameter, consumes) {
    ...
    let schemaToCoerce = parameter;

    if (!parameter.type && parameter.schema.type) {
        schemaToCoerce = parameter.schema;
    }

    switch (schemaToCoerce.type) {
        case 'array':
            fn = function (data) {
        ...
        case 'number':
            fn = function (data) {
                ...
                if (schemaToCoerce.format === 'int64') {
                    return data;
                }
