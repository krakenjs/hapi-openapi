    ...
    return {
      ...
      routeExt: function (request, h) {
        ...
        if (request[p][parameter.name] !== undefined) {
          request[p][parameter.name] = coerce && request[p][parameter.name] &&
    ...
    for (const parameter of parameters) {
      ...
      switch (validator.parameter.in) {
        ...
        case "path":
          ...
          validate
            .params[validator.parameter.name.replace(/(\*[0-9]*|\?)$/, "")] =
              validator.schema;
          routeExt.push(validator.routeExt);
          break;
        case "body":
          ...
          break;
        case "formData":
          formValidators[validator.parameter.name] = formValidator.bind(
            validator,
          );
          break;
        default:
