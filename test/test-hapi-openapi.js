...
Test("test plugin", function (t) {
    t.test("register", async function (t) {
        ...
        try {
            ...
            t.ok(
                server.plugins.openapi.getApi,
                "server.plugins.openapi.api exists."
            );
            t.ok(
                server.plugins.openapi.setHost,
                "server.plugins.openapi.setHost exists."
            );

            server.plugins.openapi.setHost("api.paypal.com");

            t.strictEqual(
                server.plugins.openapi.getApi().host,
                "api.paypal.com",
                "server.plugins.openapi.setHost set host."
            );
        } catch (error) {
    ...
    t.test(
        'register with optional query parameters does not change "request.orig"',
        async function (t) {
            t.plan(1);
            ...
            try {
                ...
                t.ok(
                    Object.entries(result.query).length === 0,
                    "request.orig was not modified"
                );
            } catch (error) {
                t.fail(error.message);
            }
    ...
    t.test("api docs", async function (t) {
        ...
        try {
            ...
            t.equal(
                body.paths["/pets"].get.parameters[0]["x-meta"],
                undefined,
                "stripped x- from array."
            );
        } catch (error) {
            t.fail(error.message);
        }
    ...
    t.test(
        "api docs change path (with no basepath prefix)",
        async function (t) {
            t.plan(1);
    ...
    t.test("routes", async function (t) {
        ...
        try {
            ...
            t.strictEqual(
                response.statusCode,
                400,
                `${response.request.path} payload bad.`
            );
        ...
        try {
            await server.register({
                ...
                options: {
                    api: Path.join(
                        __dirname,
                        "./fixtures/defs/pets_xhandlers.json"
                    ),
                },
            });
    ...
    t.test("query validation", async function (t) {
        ...
        try {
            ...
            for (const queryString in queryStringToStatusCode) {
                ...
                t.strictEqual(
                    response.statusCode,
                    queryStringToStatusCode[queryString],
                    queryString
                );
            }
    ...
    t.test("parse description from api definition", async function (t) {
        ...
        t.test(
            "create the right description for the route",
            async function (t) {
                t.plan(1);
                ...
                try {
                            ...
                            api: {
                                ...
                                paths: {
                                    "/test": {
                                        get: {
                                            description:
                                                "A simple description for the route",
                                            responses: {
                                                200: {
                                                    description:
                                                        "default response",
                    ...
                    t.strictEqual(
                        response.request.route.settings.description,
                        "A simple description for the route"
                    );
                } catch (error) {
                    t.fail(error.message);
    ...
    t.test("hapi operation tags", async function (t) {
        ...
        try {
            ...
            t.deepEqual(
                responsteTags,
                expectedTags,
                "additional tags successfully configured"
            );
        } catch (error) {
            t.fail(error.message);
        }
...
Test("yaml support", function (t) {
    t.test("register", async function (t) {
        ...
        try {
            ...
            t.ok(
                server.plugins.openapi.getApi,
                "server.plugins.openapi.getApi exists."
            );
            t.ok(
                server.plugins.openapi.setHost,
                "server.plugins.openapi.setHost exists."
